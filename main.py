...
from utils.fetch_weather_data import get_weather, convert_K_to_C
...
def save_to_mongodb(x):
    current_weather = {
        'area': x['name'],
        'temp': convert_K_to_C(x['main']['temp']),
        'temp_min': convert_K_to_C(x['main']['temp_min']),
        'temp_max': convert_K_to_C(x['main']['temp_max']),
